...
public class ProductWebResponse {
    ...
    public ProductWebResponse(String code, String name, String purchasePackaging, Integer masterStockAmount, String salesPackaging, Integer stockAmount, String fractionIndicator, Double masterPrice, Double salePrice) {
        this.code = code;
        this.name = name;
